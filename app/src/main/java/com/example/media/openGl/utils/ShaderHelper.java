package com.example.media.openGl.utils;
...
public class ShaderHelper {
    ...
    private static int compileShader(int type, String shaderCode) {
        ...
        if (shaderObjectId == 0) {
            Log.d("ShaderHelper","could not create new shader");
            return 0;
        }
...
//        Log.d("ShaderHelper","Result of compiling source:" + "\n" + shaderCode + "\n:"
//                + glGetShaderInfoLog(shaderObjectId));

        if ((compileStatsu[0] == 0)) {
            glDeleteShader(shaderObjectId);
            Log.d("ShaderHelper","Compilation of shader failed");
            return 0;
        }
    ...
    public static int linkProgram(int vertexShaderId, int fragmentShaderId) {
        ...
        if (programObjectId == 0) {
            Log.d("ShaderHelper","Could not create new program");
            return 0;
        }
        ...
        Log.d("ShaderHelper","Result of linking program:\n" + glGetProgramInfoLog(programObjectId));

        if (linkStatus[0] == 0) {
            glDeleteProgram(programObjectId);
            Log.d("ShaderHelper","Linking of program failed");
            return 0;
        }
    ...
    public static boolean validateProgram(int programObjectId) {
        ...
        Log.d("ShaderHelper","Result of validating program: " + validateStatus[0] + "\nLog:" + glGetProgramInfoLog(programObjectId));
    ...
    public static int buildProgram(String vertexShaderSource, String fragmentShaderSource) {
        ...
        Log.d("ShaderHelper","vertex is " + vertexShaderSource + " frag is " + fragmentShaderSource);
    ...
    public static int buildProgramFromAssetFile(Context context, String vertexFileName, String fragmentFileName) {
        ...
        Log.d("ShaderHelper","vertex is " + vertexString + " frag is " + fragmentString);
